...
struct TaroJiroGrid {
    ...
    bool ok(int l1, char c1, int l2, char c2) {
        assert(l2 == -1 or l1 < l2);
    ...
    int getNumber(vector<string> _grid) {
        grid = _grid;

        int N = LEN(grid);
        vector<char> colors = {'W', 'B'};
...
// CUT begin
ifstream data("../SRM 631_DIV1_250.sample");
