...
struct EllysNumberGuessing {
    ...
    int getNumber(vector<int> _guesses, vector<int> _answers) {
        ...
        set<int> candidate;
        auto a = guesses[0] + answers[0];
        auto b = guesses[0] - answers[0];
...
// CUT begin
ifstream data("../SRM 606_DIV1_250.sample");
