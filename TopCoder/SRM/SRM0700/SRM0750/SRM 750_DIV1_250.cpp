...
struct IdenticalBags {
    ...
    long long makeBags(vector<long long> _candy, long long _bagSize) {
        candy = _candy, bagSize = _bagSize;

        return binary_search_right(0, LINF);
    }
};

// CUT begin
ifstream data("../SRM 750_DIV1_250.sample");
