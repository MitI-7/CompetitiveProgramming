...
struct FindStringEasy {
    ...
    string withPalindromicSubstrings(int _n) {
        n = _n;
...
// CUT begin
ifstream data("../SRM 746_DIV2_1000.sample");
...
bool do_test(int n, string __expected) {
    ...
    FindStringEasy *instance = new FindStringEasy();
    string __result = instance->withPalindromicSubstrings(n);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "FindStringEasy (1000 Points)" << endl << endl;
    }
