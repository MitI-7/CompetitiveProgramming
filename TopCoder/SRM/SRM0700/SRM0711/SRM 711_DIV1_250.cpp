...
struct ConsecutiveOnes {
    ...
    bool ok(const bitset<60> &b) {
        ...
        return max_num >= k and b.to_ullong() >= n;
    }

    long long get(long long _n, int _k) {
        n = _n, k = _k;
...
// CUT begin
ifstream data("../SRM 711_DIV1_250.sample");
