...
struct FoxAndFencingEasy {
    ...
    LL mov2;
    LL d;
    string WhoCanWin(int _mov1, int _mov2, int _d) {
        mov1 = _mov1, mov2 = _mov2, d = _d;
        if (d <= mov1) {
            return "Ciel";
        }
...
// CUT begin
ifstream data("../SRM 598_DIV2_1000.sample");
