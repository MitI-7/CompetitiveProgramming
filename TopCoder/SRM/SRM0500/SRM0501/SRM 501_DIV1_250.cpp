...
struct FoxPlayingGame {
    ...
    int paramA;
    int paramB;
    double theMax(int _nA, int _nB, int _paramA, int _paramB) {
        nA = _nA, nB = _nB, paramA = _paramA, paramB = _paramB;

        if (paramA == 0 or nA == 0) {
            return 0;
        }
        else if (nB == 0) {
            return (paramA * nA) / 1000.0;
        }
        else if (paramB == 0) {
            return max(0.0, (paramA * nA) / 1000.0);
        }
        else if (paramA > 0 and paramB > 0) {
            if (paramB < 1000) {
                return (paramA * nA) / 1000.0;
            }
            else {
            ...
            if (abs(paramB) < 1000) {
                return ((paramA * nA) / 1000.0) * (paramB / 1000.0);
            }
            else {
                double ans = (paramA * nA) / 1000.0;
                if (nB % 2 == 0) {
...
// CUT begin
ifstream data("../Member SRM 501_DIV1_250.sample");
