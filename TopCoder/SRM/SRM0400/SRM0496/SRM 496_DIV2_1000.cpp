...
// CUT begin
ifstream data("../SRM 496_DIV2_1000.sample");
...
bool do_test(int N, int M, int K, long long __expected) {
    time_t startClock = clock();
    PalindromfulString *instance = new PalindromfulString();
    long long __result = instance->count(N, M, K);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "PalindromfulString (1000 Points)" << endl << endl;
    }
