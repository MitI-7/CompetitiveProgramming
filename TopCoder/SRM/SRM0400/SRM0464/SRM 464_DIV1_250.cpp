...
struct ColorfulStrings {
    ...
    void func(int i, string s, vector<bool> &used, vector<string> &v) {
        if (i >= n) {
            if (ok(s)) {
                v.emplace_back(s);
            }
...
// CUT begin
ifstream data("../SRM 464_DIV1_250.sample");
