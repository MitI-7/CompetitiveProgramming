...
struct NinePuzzle {
    int getMinimumCost(string _init, string _goal) {
        auto init = make_v<int>(10);
        auto goal = make_v<int>(10);
        {
            map<char, int> d;
            d['*'] = 0;
            d['R'] = 1;
...
// CUT begin
ifstream data("../SRM 498_DIV2_950.sample");
...
bool do_test(string init, string goal, int __expected) {
    ...
    NinePuzzle *instance = new NinePuzzle();
    int __result = instance->getMinimumCost(init, goal);
...
int main(int argc, char *argv[]) {
    ...
    if (mainProcess) {
        cout << "NinePuzzle (950 Points)" << endl << endl;
    }
