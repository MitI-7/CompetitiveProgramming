...
// O(r)
template <int T> mint<T> combination_mod(long long n, long long r) {
    mint<T> ans = 1;
...
std::vector<std::vector<long long>> comb_table(long long n) {
...
int main() {
    ...
    print((ans * comb.nCr(N * M - 2, K - 2)).x);
