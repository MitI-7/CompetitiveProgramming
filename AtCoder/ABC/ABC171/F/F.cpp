...
int main() {
    ...
    Combination comb(2000100, MOD);
    auto pow25 = make_v<mint<MOD>>(K + 100);
    auto pow26 = make_v<mint<MOD>>(K + 100);
    pow25[0] = 1;
    pow26[0] = 1;
    FOR(i, 1, K + 10) {
        pow25[i] = pow25[i - 1] * 25;
    ...
    FOR(l, 0, K + 1) {
        const LL r = K - l;
        ans += pow25[l] * pow26[r] * comb.nCr(l + M - 1, M - 1);
    }
    print(ans.x);
