...
int main() {
    ...
    for (int m = 0; m < N; ++m) {
        for (int s = 0; s < N; ++s) {
            for (int e = 0; e < N; ++e) {
                if (matrix2[s][m] != INF and matrix2[m][e] != INF) {
                    if (matrix2.at(s).at(e) > matrix2.at(s).at(m) + matrix2.at(m).at(e)) {
                        matrix2.at(s).at(e) = matrix2.at(s).at(m) + matrix2.at(m).at(e);
                    }
                }
            }
        }
